...
public class RuosiamasPatiekalas extends Patiekalas {
	...
	public RuosiamasPatiekalas (
		...
		bukle = PatiekaluPateikimoBusenos.Neparuostas;
	}
	
	//trūksta konstrukoriaus, todėl kuriam šitą variantą. ar teisingas, neaišku?
	public RuosiamasPatiekalas(String string, String string2, int i, int j) {
