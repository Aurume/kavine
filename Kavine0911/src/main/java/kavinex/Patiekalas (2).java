...
public class Patiekalas {
	...
	public PatiekaluPateikimoBusenos bukle = PatiekaluPateikimoBusenos.Paruostas;
	public String busena = "uzsakytas";
	public int id_uzsakymo;
	public String laikas_uzsakymo;
	public String laikas_pateikimo;
	public Double kaina;
	...
	// reikėjo Patiekalo konstruktoriaus apibūdinimo. neaišku ar šitai padės.
	public Patiekalas(String string, String string2, int i) {
	...
	public boolean equals(Object obj){
        ...
        // System.out.println(this.pavadinimas + " " + palyginimui.);
        ...
        if(
              ...
              &&	
              	this.trukmeRuosimo() == palyginimui.trukmeRuosimo() 
              		// pridedame papildoma tikrinima patiekalu paruosimo metodui ..
              		// .. tikedamiesi, kad nepakenks ankstesniems testams
        		){
