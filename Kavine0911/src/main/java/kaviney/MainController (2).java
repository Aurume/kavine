...
public class MainController {
	...
	@GetMapping(path="/salintiProduktus") // Map ONLY GET Requests
	...
	public @ResponseBody String saugotiPatiekala (@RequestParam Integer id
			...
			, @RequestParam Double kaina
			, @RequestParam String receptas                                           //pridedu receptą.
			) {
		// @ResponseBody means the returned String is the response, not a view name
		// @RequestParam means it is a parameter from the GET or POST request
	...
	@GetMapping(path="/salintiPatiekalus") // Map ONLY GET Requests
	public @ResponseBody String keistiPatiekala ( @RequestParam Integer id ) {
